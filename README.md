...
| --------- | --------------- | --------------- |
|[benchmark_network_inference_BEELINE](benchmark_network_inference_ensemble_BEELINE/README.md)| benchmarking GRN inference against other GRN methods | Figure 2, S1-4|
