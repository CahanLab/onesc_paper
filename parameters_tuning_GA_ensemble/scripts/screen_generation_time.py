...
if os.path.exists("../output/screen_generations") == False:
    os.makedirs("../output/screen_generations")

np.linspace(5, 30, 6)
for temp_max_iter in np.linspace(5, 30, 6):
    for temp_num_gen in np.linspace(50, 300, 6):
        ...
        for data_type in subfolders: 
            ...
            output_path = os.path.join("../output/screen_generations", new_folder, data_type.split("/")[2])
