...
# plot the wild_type UMAP 
data_type = 'myeloid_progenitors_full'

save_folder_path = '../output/test_zero_floor_OneSC/myeloid_progenitors_full/wildtype/'
...
states_dict = dict()
for temp_file in os.listdir(os.path.join('../input/extract_states', data_type)):
    states_tab = pd.read_csv(os.path.join('../input/extract_states', data_type, temp_file), index_col = 0)
...
os.makedirs("../output/test_zero_floor_OneSC/myeloid_progenitors_full/wildtype_UMAPs/", exist_ok=True)

big_sim_df.to_csv(os.path.join("../output/test_zero_floor_OneSC/myeloid_progenitors_full/wildtype_UMAPs/", "big_sim_df.csv"))
UMAP_coord.to_csv(os.path.join("../output/test_zero_floor_OneSC/myeloid_progenitors_full/wildtype_UMAPs/", 'UMAP_coord.csv'))
