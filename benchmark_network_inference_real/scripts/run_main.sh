...
# run the distance similarity between simulated data and real data 
python compute_distance_similarity.py 
...
# plot out the heatmap of similarities 
Rscript plot_heatmap_simulation.R

# plot out the enetwork 
Rscript plot_networks.R